...
* Cálculo de gastos mensais
  O usuário pode inserir valores de moradia, alimentação e transporte. Ao clicar no botão, o sistema realiza a soma dos valores.

* Validação de entrada
  Caso nenhum valor seja inserido, o sistema exibe uma mensagem solicitando o preenchimento dos campos.
